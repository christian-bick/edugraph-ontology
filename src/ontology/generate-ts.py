...
def generate_relations_file(ontology, output_dir, individual_to_class):
    ...
    content += '    const transitiveCollection = (constraint.includes("Smaller") || constraint.includes("Larger"))\n'
    ...
    content += '      const transitiveCollection = (c.includes("Smaller") || c.includes("Larger"))\n'
