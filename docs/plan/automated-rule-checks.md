...
Derived inverse and parent access must not add violations. A source scan on 2026-09-11 found
no inverse predicates and three same-family conflicts, tracked under
[progression review](ontology-consolidation.md#3-refine-progression-and-its-inference-separately).
