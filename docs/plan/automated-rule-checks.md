...
- [ ] **Graph core:** complete O5–O6 on the shared loading/indexing foundation, with positive and negative fixtures.
...
- [ ] **Source/schema contracts:** O8; use existing definitions of the rules and keep
